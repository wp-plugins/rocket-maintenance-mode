...
Adds a maintenance page to your site that lets visitors know your site is down. Simply enable the maintenance mode from the plugin settings and in less than a minute you can put your site in maintenance mode. The plugin is designed for users and the UI is very intuitive and easy to use.
...
The site admins can access and make the changes normally even if the maintenance mode is activated. Visitors and other user roles will get the maintenance mode page.
